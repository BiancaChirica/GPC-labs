...
public:
    ...
    void drawRec(double lungime,int nivel,CPunct p, CVector v, int directie)
    {

        if ( nivel ==1)
        {
            //primul patrat in interior
            ...
            int lgx[] = { 2,2, 2,1,4,4,4 ,2};
            int lgy[] = { 2,1, 4,4,4,1,2,1 };
